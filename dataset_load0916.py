...
# USER_CNT = 69414  # ml-10m
# ITEM_CNT = 10472  # ml-10m
# MAX_POS = 200   # ml-10m

# USER_CNT = 15062  # mooccube
# ITEM_CNT = 28068  # mooccube
# MAX_POS = 100   # mooccube

# USER_CNT = 11816  # mooc
# ITEM_CNT = 23708  # mooc
# MAX_POS = 50   # mooc

# USER_CNT = 11644  # course
# ITEM_CNT = 692  # course
# MAX_POS = 20   # course

# USER_CNT = 4996  # peek
# ITEM_CNT = 6473  # coupeekrse
# MAX_POS = 40   # peek

USER_CNT = 5000  # ml-10m-sub
ITEM_CNT = 7813  # ml-10m-sub
MAX_POS = 150   # ml-10m-sub

# USER_CNT = 14335  # mooccourse
# ITEM_CNT = 955  # mooccourse
# MAX_POS = 25   # mooccourse

# RANDOM_MASK_CNT = 16   
# MASK_RATE = 0.2  
# SINGLE_MASK_RATE = 0.2 

RANDOM_MASK_CNT = 4   # course
MASK_RATE = 0.1  # course
SINGLE_MASK_RATE = 0.1  # course
...
def load_from_file():
    ...
    for line in fin.readlines():
        # print(line)
        user_id, item_id = line.split()  # moocube
        # user_id, item_id = line.split(' ')  # ml-1m,ml-latest
...
if __name__ == '__main__':
    hyper_params = {
        # 'total_items': 15062,  #mooccube
        # 'total_users': 28068, #mooccube
        # 'seq_len': 200,  # ml-1m
        # 'dataset_path': 'ml-20m',
        'total_items': 11816,  #mooc
        'total_users': 23708, #mooc
        'seq_len': 50,  #mooc
        'dataset_path': 'mooc',  #mooc
        'kl_weight': 0.05,
        'contrast_weight': 0.1,
        'item_embed_size': 128,
        'rnn_size': 100,
