...
hyper_params = {
    ...
    'epochs_1': 140,  # mltweeing:7  cluster=4时epoch_1=7;cluster=2时epoch_1=2;;cluster=8时epoch_1=17;
...
def train():
    ...
    # --------------------------Cluster the clients to groups(only latent view1)---------------------------    
    ...
    # --------------------------Cluster the clients to groups(view1+view2)---------------------------     
